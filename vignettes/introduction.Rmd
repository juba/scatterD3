...
Ellipses are computed by the  `ellipse.default()` function of the [ellipse package](https://cran.r-project.org/web/packages/ellipse/). The confidence level can be changed with the `ellipse_level` argument (`0.95` by default).
