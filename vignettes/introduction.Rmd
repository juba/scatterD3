...
If the default tooltips don't suit your needs, you can customize them by providing a character vector to the `tooltip_text`. This can contain HTML tags for formatting.
