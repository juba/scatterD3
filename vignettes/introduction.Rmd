...
This is not documented yet, and you'll have to dig into the JS package code to use it. Please note that to access `d3` functions you'll have to use the `d3v5` prefix.
